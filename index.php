...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-w...-...">
<button id="openPopup" class="custom-button"><i class="fas fa-robot"></i> Chat dengan Bot</button>
...
$(document).ready(function(){
    $("#openPopup").click(function(){
        // Menggunakan AJAX untuk memuat konten dari index.html
        $.ajax({
            url: "index.html",
            success: function(data){
                // Menampilkan konten dalam popup
                $("#popupContainer").html(data);
                $("#popupContainer").show(); // Menampilkan popup
            }
        });
    });
    ...
    $("#closePopup").click(function(){
        $("#popupContainer").hide(); // Menutup popup
    });
});
</script>
<style>
...
.custom-button {
  ...
  margin: 4px 2px;
  cursor: pointer;
  border-radius: 8px; /* Bentuk sudut */
  transition-duration: 0.4s; /* Efek transisi */
}

.custom-button:hover {
  background-color: #45a049; /* Warna latar saat dihover */
}
